...
extension RenderRestApi on RenderApi {
  ...
  /// Add header rule
  Future<AddHeadersResponse> addHeaders({
    required String serviceId,
    required HeaderInput body,
  }) => raw.services.addHeaders(serviceId: serviceId, body: body);

  /// Add or update secret file
  Future<SecretFile> addOrUpdateSecretFile({
    required String serviceId,
    required String envVarKey,
    required AddOrUpdateSecretFileRequest body,
  }) => raw.services.addOrUpdateSecretFile(
    serviceId: serviceId,
    envVarKey: envVarKey,
    body: body,
  );
  ...
  Future<Environment> addResourcesToEnvironment({
    required String environmentId,
    required EnvironmentResourcesPostinput body,
  }) => raw.environments.addResourcesToEnvironment(
  ...
  Future<Route> addRoute({
    required String serviceId,
    required RoutePost body,
  }) => raw.services.addRoute(serviceId: serviceId, body: body);

  /// Update autoscaling config
  Future<AutoscaleServiceResponse> autoscaleService({
    required String serviceId,
    required AutoscaleServiceRequest body,
  ...
  /// Add custom domain
  Future<List<CustomDomain>> createCustomDomain({
    required String serviceId,
    required CreateCustomDomainRequest body,
  ...
  /// Trigger deploy
  Future<Deploy> createDeploy({
    required String serviceId,
    required CreateDeployRequest body,
  ...
  Future<void> deleteCustomDomain({
    required String serviceId,
    required String customDomainNameOrId,
  }) => raw.services.deleteCustomDomain(
    serviceId: serviceId,
    customDomainNameOrId: customDomainNameOrId,
  );
  ...
  Future<void> deleteEnvGroupEnvVar({
    required String envGroupId,
    required String envVarKey,
  }) => raw.envGroups.deleteEnvGroupEnvVar(
    envGroupId: envGroupId,
    envVarKey: envVarKey,
  );

  /// Remove secret file
  Future<void> deleteEnvGroupSecretFile({
    required String envGroupId,
    required String envVarKey,
  }) => raw.envGroups.deleteEnvGroupSecretFile(
    envGroupId: envGroupId,
    envVarKey: envVarKey,
  );
  ...
  }) => raw.postgres.deletePostgresUser(
  ...
  }) => raw.registrycredentials.deleteRegistryCredential(
  ...
  Future<List<GetActiveConnectionsResponse>> getActiveConnections({
    String? startTime,
    String? endTime,
    double? resolutionSeconds,
    String? resource,
  }) => raw.metrics.getActiveConnections(
    startTime: startTime,
    endTime: endTime,
  ...
  /// Get bandwidth usage
  Future<List<GetBandwidthResponse>> getBandwidth({
    String? startTime,
    String? endTime,
    String? resource,
    String? service,
  }) => raw.metrics.getBandwidth(
    startTime: startTime,
    endTime: endTime,
    resource: resource,
    service: service,
  ...
  Future<GetBandwidthSourcesResponse> getBandwidthSources({
    ...
    String? resource,
    String? service,
  }) => raw.metrics.getBandwidthSources(
    startTime: startTime,
    endTime: endTime,
    resource: resource,
    service: service,
  ...
  /// Get CPU usage
  Future<List<GetCpuResponse>> getCpu({
    String? startTime,
    String? endTime,
    double? resolutionSeconds,
    String? resource,
  ...
  /// Get CPU limit
  Future<List<GetCpuLimitResponse>> getCpuLimit({
    String? startTime,
    String? endTime,
    double? resolutionSeconds,
    String? resource,
  ...
  /// Get CPU target
  Future<List<GetCpuTargetResponse>> getCpuTarget({
    String? startTime,
    String? endTime,
    double? resolutionSeconds,
    String? resource,
  ...
  /// Get disk capacity
  Future<List<GetDiskCapacityResponse>> getDiskCapacity({
    String? startTime,
    String? endTime,
    double? resolutionSeconds,
    String? resource,
    String? service,
  }) => raw.metrics.getDiskCapacity(
    startTime: startTime,
    endTime: endTime,
    resolutionSeconds: resolutionSeconds,
    resource: resource,
  ...
  /// Get disk usage
  Future<List<GetDiskUsageResponse>> getDiskUsage({
    String? startTime,
    String? endTime,
    double? resolutionSeconds,
    String? resource,
    String? service,
  }) => raw.metrics.getDiskUsage(
    startTime: startTime,
    endTime: endTime,
    resolutionSeconds: resolutionSeconds,
    resource: resource,
  ...
  Future<List<EnvVarWithCursor>> getEnvVarsForService({
    required String serviceId,
    String? cursor,
    int? limit,
  }) => raw.services.getEnvVarsForService(
    serviceId: serviceId,
    cursor: cursor,
    limit: limit,
  );
  ...
  /// Get HTTP latency
  Future<List<GetHttpLatencyResponse>> getHttpLatency({
    String? startTime,
    String? endTime,
    double? resolutionSeconds,
    String? resource,
  ...
  Future<List<GetHttpRequestsResponse>> getHttpRequests({
    String? startTime,
    String? endTime,
    double? resolutionSeconds,
    String? resource,
  ...
  /// Get instance count
  Future<List<GetInstanceCountResponse>> getInstanceCount({
    String? startTime,
    String? endTime,
    double? resolutionSeconds,
    String? resource,
    String? service,
  }) => raw.metrics.getInstanceCount(
    startTime: startTime,
    endTime: endTime,
    resolutionSeconds: resolutionSeconds,
    resource: resource,
  ...
  /// Get memory usage
  Future<List<GetMemoryResponse>> getMemory({
    String? startTime,
    String? endTime,
    double? resolutionSeconds,
    String? resource,
  ...
  /// Get memory limit
  Future<List<GetMemoryLimitResponse>> getMemoryLimit({
    String? startTime,
    String? endTime,
    double? resolutionSeconds,
    String? resource,
  ...
  /// Get memory target
  Future<List<GetMemoryTargetResponse>> getMemoryTarget({
    String? startTime,
    String? endTime,
    double? resolutionSeconds,
    String? resource,
  ...
  Future<GetOwnerMetricsStreamResponse> getOwnerMetricsStream({
    required String ownerId,
  }) => raw.metricsStream.getOwnerMetricsStream(ownerId: ownerId);

  /// Get replica lag
  Future<List<GetReplicationLagResponse>> getReplicationLag({
    String? startTime,
    String? endTime,
    double? resolutionSeconds,
    String? resource,
  }) => raw.metrics.getReplicationLag(
    startTime: startTime,
    endTime: endTime,
    resolutionSeconds: resolutionSeconds,
    resource: resource,
  ...
  Future<List<GetTaskRunsCompletedResponse>> getTaskRunsCompleted({
    String? startTime,
    String? endTime,
    double? resolutionSeconds,
    String? resource,
    String? state,
    String? aggregateBy,
  }) => raw.metrics.getTaskRunsCompleted(
    startTime: startTime,
    endTime: endTime,
    resolutionSeconds: resolutionSeconds,
    resource: resource,
  ...
  Future<List<GetTaskRunsQueuedResponse>> getTaskRunsQueued({
    String? startTime,
    String? endTime,
    double? resolutionSeconds,
    String? resource,
  }) => raw.metrics.getTaskRunsQueued(
    startTime: startTime,
    endTime: endTime,
    resolutionSeconds: resolutionSeconds,
    resource: resource,
  ...
  Future<User> getUser() => raw.users.getUser();
  ...
  }) => raw.workflowversions.getWorkflowVersion(
    workflowVersionId: workflowVersionId,
  );

  /// Link service
  Future<EnvGroup> linkServiceToEnvGroup({
    required String envGroupId,
    required String serviceId,
  }) => raw.envGroups.linkServiceToEnvGroup(
    envGroupId: envGroupId,
    serviceId: serviceId,
  );

  /// List queryable instance values
  Future<List<ListApplicationFilterValuesResponse>>
  listApplicationFilterValues({
    ...
    String? resource,
    String? service,
  }) => raw.metrics.listApplicationFilterValues(
    startTime: startTime,
    endTime: endTime,
    resolutionSeconds: resolutionSeconds,
    resource: resource,
  ...
  Future<List<SyncWithCursor>> listBlueprintSyncs({
    ...
    String? cursor,
    int? limit,
  }) => raw.blueprints.listBlueprintSyncs(
  ...
  /// List custom domains
  Future<List<CustomDomainWithCursor>> listCustomDomains({
    required String serviceId,
    String? cursor,
    int? limit,
    List<String>? name,
    ...
    String? createdAfter,
  }) => raw.services.listCustomDomains(
    serviceId: serviceId,
    cursor: cursor,
    limit: limit,
    name: name,
  ...
  }) => raw.dedicatedIps.listDedicatedIps(
    ownerId: ownerId,
    environmentId: environmentId,
  );

  /// List deploys
  Future<List<DeployWithCursor>> listDeploys({
    required String serviceId,
    List<String>? status,
    String? createdBefore,
    String? createdAfter,
    ...
    String? updatedAfter,
    String? finishedBefore,
    String? finishedAfter,
    String? cursor,
    int? limit,
  }) => raw.services.listDeploys(
    serviceId: serviceId,
    status: status,
    createdBefore: createdBefore,
    createdAfter: createdAfter,
  ...
  Future<List<EnvGroupMeta>> listEnvGroups({
    List<String>? name,
    String? createdBefore,
    String? createdAfter,
    String? updatedBefore,
  ...
  /// List environments
  Future<List<EnvironmentWithCursor>> listEnvironments({
    List<String>? name,
    ...
    String? cursor,
    int? limit,
  }) => raw.environments.listEnvironments(
    name: name,
    projectId: projectId,
    createdBefore: createdBefore,
    createdAfter: createdAfter,
  ...
  /// List events
  Future<List<ServiceEventWithCursor>> listEvents({
    required String serviceId,
    Object? type,
    String? startTime,
    String? endTime,
  ...
  /// List header rules
  Future<List<HeaderWithCursor>> listHeaders({
    required String serviceId,
    List<String>? path,
    List<String>? name,
    List<String>? value,
  ...
  Future<List<ListHttpFilterValuesResponse>> listHttpFilterValues({
    String? startTime,
    String? endTime,
    double? resolutionSeconds,
    String? resource,
    ...
    String? host,
    String? statusCode,
  }) => raw.metrics.listHttpFilterValues(
    startTime: startTime,
    endTime: endTime,
    resolutionSeconds: resolutionSeconds,
    resource: resource,
  ...
  /// List jobs
  Future<List<JobWithCursor>> listJob({
    required String serviceId,
    String? cursor,
    int? limit,
    List<String>? status,
  ...
  Future<List<ListMaintenanceResponse>> listMaintenance({
    ...
    List<String>? ownerId,
    List<String>? state,
  }) => raw.maintenance.listMaintenance(
  ...
  Future<List<NotificationOverrideWithCursor>> listNotificationOverrides({
    ...
    String? cursor,
    int? limit,
  }) => raw.notificationSettings.listNotificationOverrides(
    ownerId: ownerId,
    serviceId: serviceId,
    cursor: cursor,
    limit: limit,
  ...
  Future<List<AuditLogWithCursor>> listOrganizationAuditLogs({
    ...
    String? cursor,
    int? limit,
  }) => raw.organizations.listOrganizationAuditLogs(
    orgId: orgId,
    startTime: startTime,
    endTime: endTime,
    direction: direction,
  ...
  Future<List<Object?>> listPathFilterValues({
    String? startTime,
    String? endTime,
    double? resolutionSeconds,
    String? resource,
    ...
    String? statusCode,
    String? path,
  }) => raw.metrics.listPathFilterValues(
    startTime: startTime,
    endTime: endTime,
    resolutionSeconds: resolutionSeconds,
    resource: resource,
  ...
  Future<List<RegistryCredential>> listRegistryCredentials({
    ...
    String? cursor,
    int? limit,
  }) => raw.registrycredentials.listRegistryCredentials(
    name: name,
    username: username,
    type: type,
    createdBefore: createdBefore,
  ...
  Future<List<ListResourceLogStreamsResponse>> listResourceLogStreams({
    ...
    String? cursor,
    int? limit,
  }) => raw.logs.listResourceLogStreams(
    ownerId: ownerId,
  ...
  Future<List<RouteWithCursor>> listRoutes({
    required String serviceId,
    List<String>? type,
    List<String>? source,
  ...
  /// List secret files
  Future<List<SecretFileWithCursor>> listSecretFilesForService({
    required String serviceId,
    String? cursor,
    int? limit,
  }) => raw.services.listSecretFilesForService(
    serviceId: serviceId,
    cursor: cursor,
    limit: limit,
  );
  ...
  /// List services
  Future<List<ServiceWithCursor>> listServices({
    List<String>? name,
    List<String>? type,
    List<String>? environmentId,
    List<String>? env,
  ...
  Future<List<WebhookEventWithCursor>> listWebhookEvents({
    ...
    int? limit,
    String? cursor,
  }) => raw.webhooks.listWebhookEvents(
    webhookId: webhookId,
  ...
  Future<List<WorkflowVersionWithCursor>> listWorkflowVersions({
    ...
    String? cursor,
    int? limit,
  }) => raw.workflowversions.listWorkflowVersions(
    ownerId: ownerId,
    workflowId: workflowId,
    workflowVersionId: workflowVersionId,
    cursor: cursor,
  ...
  }) => raw.notificationSettings.patchOwnerNotificationSettings(
    ownerId: ownerId,
    body: body,
  );

  /// Update redirect/rewrite rule priority
  Future<PatchRouteResponse> patchRoute({
    required String serviceId,
    required String routeId,
    required RoutePatch body,
  }) => raw.services.patchRoute(
    serviceId: serviceId,
    routeId: routeId,
    body: body,
  );
  ...
  }) => raw.notificationSettings.patchServiceNotificationOverrides(
    serviceId: serviceId,
    body: body,
  );

  /// Create job
  Future<PostJobResponse> postJob({
    required String serviceId,
    required PostJobRequest body,
  }) => raw.services.postJob(serviceId: serviceId, body: body);

  /// Create service preview (image-backed)
  Future<ServiceAndDeploy> previewService({
    required String serviceId,
    required PreviewInput body,
  ...
  Future<List<Route>> putRoutes({
    required String serviceId,
    required List<RoutePut> body,
  ...
  Future<void> refreshCustomDomain({
    required String serviceId,
    required String customDomainNameOrId,
  }) => raw.services.refreshCustomDomain(
    serviceId: serviceId,
    customDomainNameOrId: customDomainNameOrId,
  );

  /// Remove resources from environment
  Future<void> removeResourcesFromEnvironment({
    required String environmentId,
    required List<String> resourceIds,
  }) => raw.environments.removeResourcesFromEnvironment(
    environmentId: environmentId,
  ...
  Future<CustomDomain> retrieveCustomDomain({
    required String serviceId,
    required String customDomainNameOrId,
  }) => raw.services.retrieveCustomDomain(
    serviceId: serviceId,
    customDomainNameOrId: customDomainNameOrId,
  );
  ...
  Future<EnvVar> retrieveEnvGroupEnvVar({
    required String envGroupId,
    required String envVarKey,
  }) => raw.envGroups.retrieveEnvGroupEnvVar(
    envGroupId: envGroupId,
    envVarKey: envVarKey,
  );

  /// Retrieve secret file
  Future<SecretFile> retrieveEnvGroupSecretFile({
    required String envGroupId,
    required String envVarKey,
  }) => raw.envGroups.retrieveEnvGroupSecretFile(
    envGroupId: envGroupId,
    envVarKey: envVarKey,
  );

  /// Retrieve environment variable
  Future<EnvVar> retrieveEnvVar({
    required String serviceId,
    required String envVarKey,
  ...
  /// Retrieve job
  Future<RetrieveJobResponse> retrieveJob({
    required String serviceId,
    required String jobId,
  ...
  retrieveOwnerNotificationSettings({required String ownerId}) => raw
      .notificationSettings
      .retrieveOwnerNotificationSettings(ownerId: ownerId);
  ...
  Future<RegistryCredential> retrieveRegistryCredential({
    required String registryCredentialId,
  }) => raw.registrycredentials.retrieveRegistryCredential(
    registryCredentialId: registryCredentialId,
  );

  /// Retrieve secret file
  Future<SecretFile> retrieveSecretFile({
    required String serviceId,
    required String envVarKey,
  }) => raw.services.retrieveSecretFile(
    serviceId: serviceId,
    envVarKey: envVarKey,
  );
  ...
  retrieveServiceNotificationOverrides({required String serviceId}) => raw
      .notificationSettings
      .retrieveServiceNotificationOverrides(serviceId: serviceId);
  ...
  /// Roll back deploy
  Future<Deploy> rollbackDeploy({
    required String serviceId,
    required RollbackDeployRequest body,
  ...
  Future<void> scaleService({
    required String serviceId,
    required ScaleServiceRequest body,
  ...
  /// Unlink service
  Future<void> unlinkServiceFromEnvGroup({
    required String envGroupId,
    required String serviceId,
  }) => raw.envGroups.unlinkServiceFromEnvGroup(
    envGroupId: envGroupId,
    serviceId: serviceId,
  );
  ...
  }) => raw.dedicatedIps.updateDedicatedIp(
    dedicatedIpId: dedicatedIpId,
    body: body,
  );
  ...
  Future<EnvGroup> updateEnvGroup({
    required String envGroupId,
    required EnvGroupPatchinput body,
  }) => raw.envGroups.updateEnvGroup(envGroupId: envGroupId, body: body);

  /// Add or update environment variable
  Future<EnvGroup> updateEnvGroupEnvVar({
    required String envGroupId,
    required String envVarKey,
    required AddUpdateEnvVarInput body,
  }) => raw.envGroups.updateEnvGroupEnvVar(
    envGroupId: envGroupId,
    envVarKey: envVarKey,
    body: body,
  );
  ...
  /// Add or update secret file
  Future<EnvGroup> updateEnvGroupSecretFile({
    required String envGroupId,
    required String envVarKey,
    required UpdateEnvGroupSecretFileRequest body,
  }) => raw.envGroups.updateEnvGroupSecretFile(
    envGroupId: envGroupId,
    envVarKey: envVarKey,
    body: body,
  );
  ...
  /// Add or update environment variable
  Future<EnvVar> updateEnvVar({
    required String serviceId,
    required String envVarKey,
    required AddUpdateEnvVarInput body,
  }) => raw.services.updateEnvVar(
    serviceId: serviceId,
    envVarKey: envVarKey,
    body: body,
  );
  ...
  Future<List<EnvVarWithCursor>> updateEnvVarsForService({
    required String serviceId,
    required List<UpdateEnvVarsForServiceRequestItem> body,
  }) => raw.services.updateEnvVarsForService(serviceId: serviceId, body: body);

  /// Update environment
  Future<Environment> updateEnvironment({
    required String environmentId,
    required EnvironmentPatchinput body,
  }) => raw.environments.updateEnvironment(
    environmentId: environmentId,
    body: body,
  );

  /// Replace header rules
  Future<List<Header>> updateHeaders({
    required String serviceId,
    required List<HeaderInput> body,
  ...
  }) => raw.maintenance.updateMaintenance(
  ...
  }) => raw.registrycredentials.updateRegistryCredential(
    registryCredentialId: registryCredentialId,
    body: body,
  );
  ...
  /// Update secret files
  Future<List<SecretFileWithCursor>> updateSecretFilesForService({
    required String serviceId,
    required List<UpdateSecretFilesForServiceRequestItem> body,
  }) => raw.services.updateSecretFilesForService(
    serviceId: serviceId,
    body: body,
  );
  ...
  }) => raw.owners.updateWorkspaceMember(
    ownerId: ownerId,
    userId: userId,
    body: body,
  );
  ...
  Future<UpsertOwnerMetricsStreamResponse> upsertOwnerMetricsStream({
    required String ownerId,
    required UpsertOwnerMetricsStreamRequest body,
  }) =>
