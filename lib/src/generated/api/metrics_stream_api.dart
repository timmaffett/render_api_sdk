...
class MetricsStreamEndpoints {
  ...
  Future<Map<String, Object?>> getOwnerMetricsStream(String ownerId) async {
  ...
  Future<Map<String, Object?>> upsertOwnerMetricsStream(String ownerId, {required Map<String, Object?> body}) async {
    final json = await _client.sendObject(
      'PUT',
      '/metrics-stream/$ownerId',
      body: body,
  ...
  Future<void> deleteOwnerMetricsStream(String ownerId) async {
    await _client.send(
      'DELETE',
      '/metrics-stream/$ownerId',
    );
