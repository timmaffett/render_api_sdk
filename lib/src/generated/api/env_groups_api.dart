...
class EnvGroupsEndpoints {
  ...
  Future<void> deleteEnvGroup({required String envGroupId}) async {
    await _client.send('DELETE', '/env-groups/$envGroupId');
  }
  ...
  Future<void> unlinkServiceFromEnvGroup({
    ...
    await _client.send('DELETE', '/env-groups/$envGroupId/services/$serviceId');
  }
  ...
  Future<void> deleteEnvGroupEnvVar({
    ...
    await _client.send('DELETE', '/env-groups/$envGroupId/env-vars/$envVarKey');
  }
